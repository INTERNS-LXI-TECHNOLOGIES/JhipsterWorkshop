...
/**
 * REST controller for managing {@link com.lxisoft.socialmedia.domain.Reaction}.
 */
@RestController
...
public class ReactionResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Reaction>> getAllReactions(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Reaction> getReaction(@PathVariable("id") Long id) {
