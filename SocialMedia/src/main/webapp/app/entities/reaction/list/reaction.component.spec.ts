...
describe('Reaction Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'reaction', component: ReactionComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to reactionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getReactionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getReactionIdentifier).toHaveBeenCalledWith(entity);
