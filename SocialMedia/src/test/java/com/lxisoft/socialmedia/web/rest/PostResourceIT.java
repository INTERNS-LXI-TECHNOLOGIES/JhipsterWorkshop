...
class PostResourceIT {
    ...
    private static final String DEFAULT_HASH_TAGS = "AAAAAAAAAA";
    private static final String UPDATED_HASH_TAGS = "BBBBBBBBBB";
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().createdAt(DEFAULT_CREATED_AT).content(DEFAULT_CONTENT).hashTags(DEFAULT_HASH_TAGS);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().createdAt(UPDATED_CREATED_AT).content(UPDATED_CONTENT).hashTags(UPDATED_HASH_TAGS);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getHashTags()).isEqualTo(DEFAULT_HASH_TAGS);
    }
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].hashTags").value(hasItem(DEFAULT_HASH_TAGS)));
    }
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.hashTags").value(DEFAULT_HASH_TAGS));
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.createdAt(UPDATED_CREATED_AT).content(UPDATED_CONTENT).hashTags(UPDATED_HASH_TAGS);
        ...
        assertThat(testPost.getHashTags()).isEqualTo(UPDATED_HASH_TAGS);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.createdAt(UPDATED_CREATED_AT).content(UPDATED_CONTENT);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.createdAt(UPDATED_CREATED_AT).content(UPDATED_CONTENT).hashTags(UPDATED_HASH_TAGS);
